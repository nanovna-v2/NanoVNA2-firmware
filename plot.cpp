...
uint32_t
trace_into_index(int x, int t, int i, complexf coeff)
{
	int y = 0;
	float v = 0;
...
static void
gamma2imp(char *buf, int len, complexf coeff, uint32_t frequency)
{
...
static void
trace_get_value_string(int t, char *buf, int len, complexf coeff, uint32_t frequency)
{
	float v;
	switch (trace[t].type) {
	case TRC_LOGMAG:
